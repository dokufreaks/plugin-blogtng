<?php
/**
 * Chinese language file for the Config Manager
 *
...
$lang['comments_allow_web']        = '允许用户将网站链接到评论上？';
$lang['comments_subscription']     = '允许用户通过邮件订阅新评论？';
$lang['comments_gravatar_rating']  = 'gravatar 的最低评级。';
$lang['comments_gravatar_default'] = '对没有 gravatar 图像的用户所用的头像。';
$lang['comments_xhtml_renderer']   = '评论中，用默认的 XHTML 渲染器而非特殊的评论渲染器来进行渲染的语法插件。以此支持那些并不原生支持评论渲染器的语法插件。';
$lang['comments_forbid_syntax']    = '在评论中完全禁止的语法插件(无论是通过 XHTML 还是评论渲染器)。';
